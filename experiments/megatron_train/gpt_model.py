...
def post_language_model_processing(lm_output, labels, logit_weights,
    ...
    lookup_probabilities = lookup_probabilities.to(lm_output.device)# [V]        
    ...
    if labels is None:
        ...
        if fp16_lm_cross_entropy:
            ...
            loss = tensor_parallel.vocab_parallel_cross_entropy(output, labels, lookup_probabilities)
        else:                                                                                
            loss = tensor_parallel.vocab_parallel_cross_entropy(output.float(), labels, lookup_probabilities)
...
class GPTModel(MegatronModule):
    ...
    def forward(self, input_ids, position_ids, attention_mask, labels=None,
                tokentype_ids=None, inference_params=None, lookup_probabilities=None):
